...
function EventAgenda() {
  ...
  const handleSwipright = (e) => {
    if (
      e.target.src ===
      "http://localhost:5173/src/assets/eventAgenda/btn-day2-right.png"
    ) {
      setBtnR(btnD3);
      setBtnL(btnD1);
      setSlide("Day2");
      ...
      e.target.src ===
      "http://localhost:5173/src/assets/eventAgenda/btn-day3.png"
    ) {
      setBtnR("");
      setBtnL(btnD2Left);
      setSlide("Day3");
  ...
  const handleSwipleft = (e) => {
    if (
      e.target.src ===
      "http://localhost:5173/src/assets/eventAgenda/btn-day2-left.png"
    ) {
      setBtnR(btnD3);
      setBtnL(btnD1);
      setSlide("Day2");
      ...
      e.target.src ===
      "http://localhost:5173/src/assets/eventAgenda/btn-day1.png"
    ) {
      setBtnR(btnD2Right);
      setBtnL("");
      setSlide("Day1");
  ...
  return (
    <>
      <section className="w-screen overflow-hidden flex justify-center flex-col items-center h-screen relative section">
