...
const Form3 = ({ formHandler, handlers }) => {
  ...
  return (
    <div className="flex flex-col justify-between gap-[30px] h-full">
      <div className="form2 flex flex-col col-span-2">
        <article className="flex flex-col items-start gap-[10px]">
          ...
          <textarea
            ...
            type="text"
            className=" h-full px-[26px] w-full  bg-white text-black py-3 border-none outline-none rounded-[18px]"
          />
        </article>
      ...
      <div className="flex justify-between gap-[15px] items-center">
        ...
        >
          <span className="  glow-text uppercase ">NEXT</span>
